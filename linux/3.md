...
![bg2013081702](../img/bg2013081702.png)
...
![bg2013081703](../img/bg2013081703.png)
...
![bg2013081704](../img/bg2013081704.png)
...
![bg2013081705](../img/bg2013081705.png)
...
![bg2013081706](../img/bg2013081706.png)
...
<p在分析完用户名后，login将搜索 etc="" passwd以及="" shadow来验证密码以及设置账户的其它信息，比如：主目录是什么、使用何种shell。如果没有指定主目录，将默认为根目录；如果没有指定shell，将默认为="" bin="" bash。<="" p="">
...
![bg2013081707](../img/bg2013081707.png)
